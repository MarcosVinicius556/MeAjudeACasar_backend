...
import { findAll, findById, insert, remove, update } from '../controllers/giftController';
 ...
 */
giftRouter.get('/byGiftList/:giftListId', authenticateUserAccess, findAll);
 ...
 *       - Gifts
 */
giftRouter.post('/:giftListId', authenticateUserAccess, insert);
 ...
 *       - Gifts
 */
giftRouter.put('/:giftListId/:giftId', authenticateUserAccess, update);
 ...
 *       - Gifts
 */
giftRouter.delete('/:giftListId/:giftId', authenticateUserAccess, remove);
